...
$sousmenu .= '<h1>Gestion des membres</h1>';
	...
	if (isset($_GET['id']) && is_numeric($_GET['id'])) {
		...
		$contenu .= '<form action="" method="post">';
			...
			$contenu .= '<select name="etat" id="etat">';
				...
				$contenu .= '<option value="envoyé">Envoyé</option>';
				$contenu .= '<option value="livré">Livré</option>';
				$contenu .= '<option value="annulé">Annulé</option>';
			$contenu .= '<\select>';
